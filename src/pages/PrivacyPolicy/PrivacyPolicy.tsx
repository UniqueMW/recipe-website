      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to uniquemw recipe.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to uniquemw recipe, accessible from{' '}
            <a href="https://uniquemw-recipe" rel="noreferrer" target="_blank">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            such as a mobile application`&apos`s push notifications regarding
