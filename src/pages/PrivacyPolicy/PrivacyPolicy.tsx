  ...
  return (
    <>
      ...
      <section className="md:text-lg text-base font-sans px-2 md:px-12 mt-20">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to uniquemw recipe.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to uniquemw recipe, accessible
              from{' '}
              <a
                href="https://uniquemw-recipe"
                rel="noreferrer"
                target="_blank"
              >
                https://uniquemw-recipe
              </a>
            </p>
          </li>
          <li>
        ...
        <p>
          Usage Data may include information such as Your Device`&apos`s
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              communication, such as a mobile application`&apos`s push
        ...
        <p>
          ...
          that third party`&apos`s site. We strongly advise You to review the
        ...
        <ul>
          <li>By email: clifflikovodeveloper@gmail.com</li>
        </ul>
      </section>
    </>
  )
